...
/** Module that provides ConfigReader for ASR feature. */
@Module
@InstallIn(SingletonComponent.class)
interface PcsAsrConfigModule {
  @Provides
  static ConfigReader<PcsAsrConfig> provideConfigReader(
      FlagManagerFactory flagManagerFactory, @GeneralExecutorQualifier Executor executor) {
    return PcsAsrConfigReader.create(
