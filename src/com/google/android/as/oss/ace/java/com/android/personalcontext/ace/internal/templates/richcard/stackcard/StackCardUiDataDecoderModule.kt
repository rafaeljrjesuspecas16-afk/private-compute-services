...
interface StackCardUiDataDecoderModule {
  /** Binds the [StackCardUiDataDecoder] into the map of card decoders. */
  @Binds
  @IntoMap
  @CardTypeKey(CardType.RICH_CARD_STACK)
  fun bindStackCardUiDataDecoder(
    decoder: StackCardUiDataDecoder
