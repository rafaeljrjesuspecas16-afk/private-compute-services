...
package com.android.personalcontext.ace.client.prototype.clientaction.params.sharelivelocation
...
/** Parameters for SHARE_LIVE_LOCATION ClientAction. */
class ShareLiveLocationParams : ClientActionParams() {
  override val id = ClientActionParamId.SHARE_LIVE_LOCATION

  companion object : ClientActionParams.Creator {
    override fun create(bundle: Bundle): ShareLiveLocationParams = ShareLiveLocationParams()
  }
}
