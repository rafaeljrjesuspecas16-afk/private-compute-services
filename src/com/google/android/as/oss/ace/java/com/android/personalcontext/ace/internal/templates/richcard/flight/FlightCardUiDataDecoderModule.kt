...
interface FlightCardUiDataDecoderModule {
  /** Binds the [FlightCardUiDataDecoder] into the map of card decoders. */
  @Binds
  @IntoMap
  @CardTypeKey(CardType.FLIGHT)
  fun bindFlightCardUiDataDecoder(
    decoder: FlightCardUiDataDecoder
