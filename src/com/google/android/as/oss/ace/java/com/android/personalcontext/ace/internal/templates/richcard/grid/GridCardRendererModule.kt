...
interface GridCardRendererModule {
  @Binds
  @IntoMap
  @CardTypeKey(CardType.RICH_CARD_GRID)
  fun bindGridCardRenderer(renderer: GridCardRenderer): CardRenderer<out DeprecatedUiCardContext>
}
