...
interface ImageGalleryCardUiDataDecoderModule {
  @Binds
  @IntoMap
  @CardTypeKey(CardType.RICH_CARD_IMAGE_GALLERY)
  fun bindImageGalleryCardUiDataDecoder(
    decoder: ImageGalleryCardUiDataDecoder
