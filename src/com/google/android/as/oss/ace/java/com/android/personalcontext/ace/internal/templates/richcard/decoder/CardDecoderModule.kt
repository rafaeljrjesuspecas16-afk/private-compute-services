...
interface CardDecoderModule {
  @Binds
  @IntoMap
  @CardTypeKey(CardType.SIMPLE)
  fun bindSimpleCardUiDataConverter(
    converter: SimpleCardUiDataDecoder
  ): CardUiDataDecoder<out DeprecatedUiCardContext>

  @Binds
  @IntoMap
  @CardTypeKey(CardType.GRID)
  fun bindGridCardUiDataConverter(
    converter: GridCardUiDataDecoder
  ): CardUiDataDecoder<out DeprecatedUiCardContext>
}
