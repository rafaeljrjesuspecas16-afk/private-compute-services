...
interface LocationPreviewCardUiDataDecoderModule {
  /** Binds the [LocationPreviewCardUiDataDecoder] into the map of card decoders. */
  @Binds
  @IntoMap
  @CardTypeKey(CardType.LOCATION_PREVIEW)
  fun bindLocationPreviewCardDecoder(
    decoder: LocationPreviewCardUiDataDecoder
