 ...
 */
interface ClientActionInsightCompat {
  /**
   * Runs the [block] if [ContextInsight] is a client action insight, providing the safely validated
   * insight as a parameter to the lambda. Returns null if it is not a client action insight.
   */
  fun <T> ifClientActionInsight(
