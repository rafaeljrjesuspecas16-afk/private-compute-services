...
package com.android.personalcontext.ace.client.prototype.republish
...
class DoNotRepublishHint() : PrototypeHint(DoNotRepublishHintId, this) {
  ...
  companion object : Creator {
    override fun create(bundle: Bundle): PrototypeHint = DoNotRepublishHint()
  }
}
