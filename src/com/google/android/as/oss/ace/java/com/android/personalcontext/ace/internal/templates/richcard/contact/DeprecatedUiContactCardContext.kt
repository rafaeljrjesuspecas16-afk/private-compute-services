...
/** Card Context for a Contact info in a rich card. */
@Deprecated(
  level = DeprecationLevel.WARNING,
  message = "Should be removed once the templates is fully refactored.",
)
data class DeprecatedUiContactCardContext(
  // Required fields from L1 memory
  val name: String,

  // Optional fields from L1 memory
  val phoneNumber: String? = null,
  val emailAddress: String? = null,
  val address: String? = null,
  val birthday: String? = null,
) : DeprecatedUiCardContext {
  override val cardType: CardType = CardType.CONTACT
}
