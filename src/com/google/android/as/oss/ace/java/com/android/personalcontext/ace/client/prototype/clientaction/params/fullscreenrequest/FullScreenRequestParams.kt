...
package com.android.personalcontext.ace.client.prototype.clientaction.params.fullscreenrequest
...
/** Parameters for FULL_SCREEN_REQUEST ClientAction. */
class FullScreenRequestParams : ClientActionParams() {
  override val id = ClientActionParamId.FULL_SCREEN_REQUEST

  companion object : ClientActionParams.Creator {
    override fun create(bundle: Bundle): FullScreenRequestParams = FullScreenRequestParams()
  }
}
